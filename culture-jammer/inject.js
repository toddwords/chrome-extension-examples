...
function changeWebContent(){
	...
	if(checkWebAddress("tacobell.com")){
		...
		replaceText("WARNING", "OPPORTUNITY")
		
	}

	if(checkWebAddress("food")){
		replaceText("Chicken", "Human")
		replaceText("Steak", "Human")
		replaceText("Pork", "Human")
		replaceText("Sausage", "Human")
		replaceText("Pumpkin", "Human")
		replaceText("Cheese", "Blood")
	}
	...
	if(checkWebAddress("risd.edu/academics/faculty")){
		replaceImages(["https://vcard.newschool.edu/?c=783624", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ72iD17AiAn6MbrBqy70eFniHoWLqqX4SL3A&usqp=CAU", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjlJW46nbAtFttm0n7yezMFTia6atrrEqDmg&usqp=CAU" ])
	}
